...
function findWasmBinary() {
  return locateFile("litertlm_wasm_asyncify_internal.wasm");
}
...
var ASM_CONSTS = {
  ...
  2163280: () => !!Module["preinitializedWebGPUDevice"]
};
...
var _malloc, _free, _ma_device__on_notification_unlocked, _ma_malloc_emscripten, _ma_free_emscripten, _ma_device_process_pcm_frames_capture__webaudio, _ma_device_process_pcm_frames_playback__webaudio, _wgpuDeviceAddRef, _emwgpuCreateBindGroup, _emwgpuCreateBindGroupLayout, _emwgpuCreateCommandBuffer, _emwgpuCreateCommandEncoder, _emwgpuCreateComputePassEncoder, _emwgpuCreateComputePipeline, _emwgpuCreateExternalTexture, _emwgpuCreatePipelineLayout, _emwgpuCreateQuerySet, _emwgpuCreateRenderBundle, _emwgpuCreateRenderBundleEncoder, _emwgpuCreateRenderPassEncoder, _emwgpuCreateRenderPipeline, _emwgpuCreateSampler, _emwgpuCreateSurface, _emwgpuCreateTexture, _emwgpuCreateTextureView, _emwgpuCreateAdapter, _emwgpuImportBuffer, _emwgpuCreateDevice, _emwgpuCreateQueue, _emwgpuCreateShaderModule, _emwgpuOnCreateComputePipelineCompleted, _emwgpuOnMapAsyncCompleted, _emwgpuOnWorkDoneCompleted, ___getTypeName, _emscripten_builtin_memalign, _memalign, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_vi, dynCall_v, dynCall_vii, dynCall_ii, dynCall_iii, dynCall_iiii, dynCall_viii, dynCall_i, dynCall_fi, dynCall_fii, dynCall_vif, dynCall_viif, dynCall_dii, dynCall_viid, dynCall_iiiiiiii, dynCall_viiiiiii, dynCall_viiii, dynCall_iiiii, dynCall_iiijj, dynCall_iijj, dynCall_viijj, dynCall_viiiii, dynCall_iiiiii, dynCall_viiij, dynCall_jiii, dynCall_viiiiiiiii, dynCall_jiji, dynCall_vijj, dynCall_ji, dynCall_jij, dynCall_iiiijij, dynCall_jiij, dynCall_jii, dynCall_vij, dynCall_viij, dynCall_iij, dynCall_viiiiiiii, dynCall_iiiiiiiii, dynCall_iiiiiii, dynCall_iiiiiiiiii, dynCall_ff, dynCall_fff, dynCall_viiiiii, dynCall_iiji, dynCall_iiiji, dynCall_iiiiiiiiiii, dynCall_iiiiiiiiiiii, dynCall_viiiiiiiiii, dynCall_viiiiiiiiiii, dynCall_iiif, dynCall_viji, dynCall_viijii, dynCall_viiif, dynCall_viiifiii, dynCall_fiif, dynCall_iiiifi, dynCall_iiiifiii, dynCall_iiifi, dynCall_viiiif, dynCall_viiiifii, dynCall_iiiijj, dynCall_viiijjj, dynCall_viifii, dynCall_iff, dynCall_ijj, dynCall_vfiii, dynCall_jjj, dynCall_fiii, dynCall_viiiffii, dynCall_iiiiiffi, dynCall_viiiiiff, dynCall_viiiiiiiiiiiii, dynCall_viiiiiiiiiiii, dynCall_viiiiiiiiiiiiiiiii, dynCall_iifff, dynCall_iiff, dynCall_iiifiii, dynCall_iiffi, dynCall_iiffii, dynCall_viiiiiiiiiiiiii, dynCall_iif, dynCall_vifi, dynCall_vidi, dynCall_vijjj, dynCall_vj, dynCall_iidiiiii, dynCall_iiiiij, dynCall_iiiiid, dynCall_iiiiijj, dynCall_iiiiiijj, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, memory, _kVersionStampBuildChangelistStr, _kVersionStampCitcSnapshotStr, _kVersionStampCitcWorkspaceIdStr, _kVersionStampSourceUriStr, _kVersionStampBuildClientStr, _kVersionStampBuildClientMintStatusStr, _kVersionStampBuildCompilerStr, _kVersionStampBuildDateTimePstStr, _kVersionStampBuildDepotPathStr, _kVersionStampBuildIdStr, _kVersionStampBuildInfoStr, _kVersionStampBuildLabelStr, _kVersionStampBuildTargetStr, _kVersionStampBuildTimestampStr, _kVersionStampBuildToolStr, _kVersionStampG3BuildTargetStr, _kVersionStampVerifiableStr, _kVersionStampBuildFdoTypeStr, _kVersionStampBuildBaselineChangelistStr, _kVersionStampBuildLtoTypeStr, _kVersionStampBuildPropellerTypeStr, _kVersionStampBuildPghoTypeStr, _kVersionStampBuildFdoProfileChangelistStr, _kVersionStampBuildMemprofProfileChangelistStr, _kVersionStampBuildUsernameStr, _kVersionStampBuildHostnameStr, _kVersionStampBuildDirectoryStr, _kVersionStampBuildChangelistInt, _kVersionStampCitcSnapshotInt, _kVersionStampBuildClientMintStatusInt, _kVersionStampBuildTimestampInt, _kVersionStampVerifiableInt, _kVersionStampBuildCoverageEnabledInt, _kVersionStampBuildBaselineChangelistInt, _kVersionStampPrecookedTimestampStr, _kVersionStampPrecookedClientInfoStr, __indirect_function_table, _kVersionStampBuildHasHardeningProtobuf, wasmMemory;

function assignWasmExports(wasmExports) {
  _malloc = Module["_malloc"] = wasmExports["lc"];
  _free = Module["_free"] = wasmExports["mc"];
  _ma_device__on_notification_unlocked = Module["_ma_device__on_notification_unlocked"] = wasmExports["nc"];
  _ma_malloc_emscripten = Module["_ma_malloc_emscripten"] = wasmExports["oc"];
  _ma_free_emscripten = Module["_ma_free_emscripten"] = wasmExports["pc"];
  _ma_device_process_pcm_frames_capture__webaudio = Module["_ma_device_process_pcm_frames_capture__webaudio"] = wasmExports["qc"];
  _ma_device_process_pcm_frames_playback__webaudio = Module["_ma_device_process_pcm_frames_playback__webaudio"] = wasmExports["rc"];
  _wgpuDeviceAddRef = wasmExports["sc"];
  _emwgpuCreateBindGroup = wasmExports["tc"];
  _emwgpuCreateBindGroupLayout = wasmExports["uc"];
  _emwgpuCreateCommandBuffer = wasmExports["vc"];
  _emwgpuCreateCommandEncoder = wasmExports["wc"];
  _emwgpuCreateComputePassEncoder = wasmExports["xc"];
  _emwgpuCreateComputePipeline = wasmExports["yc"];
  _emwgpuCreateExternalTexture = wasmExports["zc"];
  _emwgpuCreatePipelineLayout = wasmExports["Ac"];
  _emwgpuCreateQuerySet = wasmExports["Bc"];
  _emwgpuCreateRenderBundle = wasmExports["Cc"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["Dc"];
  _emwgpuCreateRenderPassEncoder = wasmExports["Ec"];
  _emwgpuCreateRenderPipeline = wasmExports["Fc"];
  _emwgpuCreateSampler = wasmExports["Gc"];
  _emwgpuCreateSurface = wasmExports["Hc"];
  _emwgpuCreateTexture = wasmExports["Ic"];
  _emwgpuCreateTextureView = wasmExports["Jc"];
  _emwgpuCreateAdapter = wasmExports["Kc"];
  _emwgpuImportBuffer = wasmExports["Lc"];
  _emwgpuCreateDevice = wasmExports["Mc"];
  _emwgpuCreateQueue = wasmExports["Nc"];
  _emwgpuCreateShaderModule = wasmExports["Oc"];
  _emwgpuOnCreateComputePipelineCompleted = wasmExports["Pc"];
  _emwgpuOnMapAsyncCompleted = wasmExports["Qc"];
  _emwgpuOnWorkDoneCompleted = wasmExports["Rc"];
  ___getTypeName = wasmExports["Tc"];
  _emscripten_builtin_memalign = wasmExports["Uc"];
  _memalign = wasmExports["Vc"];
  __emscripten_stack_restore = wasmExports["Wc"];
  __emscripten_stack_alloc = wasmExports["Xc"];
  _emscripten_stack_get_current = wasmExports["Yc"];
  dynCall_vi = dynCalls["vi"] = wasmExports["Zc"];
  dynCall_v = dynCalls["v"] = wasmExports["_c"];
  dynCall_vii = dynCalls["vii"] = wasmExports["$c"];
  dynCall_ii = dynCalls["ii"] = wasmExports["ad"];
  dynCall_iii = dynCalls["iii"] = wasmExports["bd"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["cd"];
  dynCall_viii = dynCalls["viii"] = wasmExports["dd"];
  dynCall_i = dynCalls["i"] = wasmExports["ed"];
  dynCall_fi = dynCalls["fi"] = wasmExports["fd"];
  dynCall_fii = dynCalls["fii"] = wasmExports["gd"];
  dynCall_vif = dynCalls["vif"] = wasmExports["hd"];
  dynCall_viif = dynCalls["viif"] = wasmExports["id"];
  dynCall_dii = dynCalls["dii"] = wasmExports["jd"];
  dynCall_viid = dynCalls["viid"] = wasmExports["kd"];
  dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["ld"];
  dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["md"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["nd"];
  dynCall_iiiii = dynCalls["iiiii"] = wasmExports["od"];
  dynCall_iiijj = dynCalls["iiijj"] = wasmExports["pd"];
  dynCall_iijj = dynCalls["iijj"] = wasmExports["qd"];
  dynCall_viijj = dynCalls["viijj"] = wasmExports["rd"];
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["sd"];
  dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["td"];
  dynCall_viiij = dynCalls["viiij"] = wasmExports["ud"];
  dynCall_jiii = dynCalls["jiii"] = wasmExports["vd"];
  dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["wd"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["xd"];
  dynCall_vijj = dynCalls["vijj"] = wasmExports["yd"];
  dynCall_ji = dynCalls["ji"] = wasmExports["zd"];
  dynCall_jij = dynCalls["jij"] = wasmExports["Ad"];
  dynCall_iiiijij = dynCalls["iiiijij"] = wasmExports["Bd"];
  dynCall_jiij = dynCalls["jiij"] = wasmExports["Cd"];
  dynCall_jii = dynCalls["jii"] = wasmExports["Dd"];
  dynCall_vij = dynCalls["vij"] = wasmExports["Ed"];
  dynCall_viij = dynCalls["viij"] = wasmExports["Fd"];
  dynCall_iij = dynCalls["iij"] = wasmExports["Gd"];
  dynCall_viiiiiiii = dynCalls["viiiiiiii"] = wasmExports["Hd"];
  dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["Id"];
  dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["Jd"];
  dynCall_iiiiiiiiii = dynCalls["iiiiiiiiii"] = wasmExports["Kd"];
  dynCall_ff = dynCalls["ff"] = wasmExports["Ld"];
  dynCall_fff = dynCalls["fff"] = wasmExports["Md"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["Nd"];
  dynCall_iiji = dynCalls["iiji"] = wasmExports["Od"];
  dynCall_iiiji = dynCalls["iiiji"] = wasmExports["Pd"];
  dynCall_iiiiiiiiiii = dynCalls["iiiiiiiiiii"] = wasmExports["Qd"];
  dynCall_iiiiiiiiiiii = dynCalls["iiiiiiiiiiii"] = wasmExports["Rd"];
  dynCall_viiiiiiiiii = dynCalls["viiiiiiiiii"] = wasmExports["Sd"];
  dynCall_viiiiiiiiiii = dynCalls["viiiiiiiiiii"] = wasmExports["Td"];
  dynCall_iiif = dynCalls["iiif"] = wasmExports["Ud"];
  dynCall_viji = dynCalls["viji"] = wasmExports["Vd"];
  dynCall_viijii = dynCalls["viijii"] = wasmExports["Wd"];
  dynCall_viiif = dynCalls["viiif"] = wasmExports["Xd"];
  dynCall_viiifiii = dynCalls["viiifiii"] = wasmExports["Yd"];
  dynCall_fiif = dynCalls["fiif"] = wasmExports["Zd"];
  dynCall_iiiifi = dynCalls["iiiifi"] = wasmExports["_d"];
  dynCall_iiiifiii = dynCalls["iiiifiii"] = wasmExports["$d"];
  dynCall_iiifi = dynCalls["iiifi"] = wasmExports["ae"];
  dynCall_viiiif = dynCalls["viiiif"] = wasmExports["be"];
  dynCall_viiiifii = dynCalls["viiiifii"] = wasmExports["ce"];
  dynCall_iiiijj = dynCalls["iiiijj"] = wasmExports["de"];
  dynCall_viiijjj = dynCalls["viiijjj"] = wasmExports["ee"];
  dynCall_viifii = dynCalls["viifii"] = wasmExports["fe"];
  dynCall_iff = dynCalls["iff"] = wasmExports["ge"];
  dynCall_ijj = dynCalls["ijj"] = wasmExports["he"];
  dynCall_vfiii = dynCalls["vfiii"] = wasmExports["ie"];
  dynCall_jjj = dynCalls["jjj"] = wasmExports["je"];
  dynCall_fiii = dynCalls["fiii"] = wasmExports["ke"];
  dynCall_viiiffii = dynCalls["viiiffii"] = wasmExports["le"];
  dynCall_iiiiiffi = dynCalls["iiiiiffi"] = wasmExports["me"];
  dynCall_viiiiiff = dynCalls["viiiiiff"] = wasmExports["ne"];
  dynCall_viiiiiiiiiiiii = dynCalls["viiiiiiiiiiiii"] = wasmExports["oe"];
  dynCall_viiiiiiiiiiii = dynCalls["viiiiiiiiiiii"] = wasmExports["pe"];
  dynCall_viiiiiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiiiiii"] = wasmExports["qe"];
  dynCall_iifff = dynCalls["iifff"] = wasmExports["re"];
  dynCall_iiff = dynCalls["iiff"] = wasmExports["se"];
  dynCall_iiifiii = dynCalls["iiifiii"] = wasmExports["te"];
  dynCall_iiffi = dynCalls["iiffi"] = wasmExports["ue"];
  dynCall_iiffii = dynCalls["iiffii"] = wasmExports["ve"];
  dynCall_viiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiii"] = wasmExports["we"];
  dynCall_iif = dynCalls["iif"] = wasmExports["xe"];
  dynCall_vifi = dynCalls["vifi"] = wasmExports["ye"];
  dynCall_vidi = dynCalls["vidi"] = wasmExports["ze"];
  dynCall_vijjj = dynCalls["vijjj"] = wasmExports["Ae"];
  dynCall_vj = dynCalls["vj"] = wasmExports["Be"];
  dynCall_iidiiiii = dynCalls["iidiiiii"] = wasmExports["Ce"];
  dynCall_iiiiij = dynCalls["iiiiij"] = wasmExports["De"];
  dynCall_iiiiid = dynCalls["iiiiid"] = wasmExports["Ee"];
  dynCall_iiiiijj = dynCalls["iiiiijj"] = wasmExports["Fe"];
  dynCall_iiiiiijj = dynCalls["iiiiiijj"] = wasmExports["Ge"];
  _asyncify_start_unwind = wasmExports["He"];
  _asyncify_stop_unwind = wasmExports["Ie"];
  _asyncify_start_rewind = wasmExports["Je"];
  _asyncify_stop_rewind = wasmExports["Ke"];
  memory = wasmMemory = wasmExports["Bb"];
  _kVersionStampBuildChangelistStr = Module["_kVersionStampBuildChangelistStr"] = (wasmExports["Db"].value) >>> 0;
  _kVersionStampCitcSnapshotStr = Module["_kVersionStampCitcSnapshotStr"] = (wasmExports["Eb"].value) >>> 0;
  _kVersionStampCitcWorkspaceIdStr = Module["_kVersionStampCitcWorkspaceIdStr"] = (wasmExports["Fb"].value) >>> 0;
  _kVersionStampSourceUriStr = Module["_kVersionStampSourceUriStr"] = (wasmExports["Gb"].value) >>> 0;
  _kVersionStampBuildClientStr = Module["_kVersionStampBuildClientStr"] = (wasmExports["Hb"].value) >>> 0;
  _kVersionStampBuildClientMintStatusStr = Module["_kVersionStampBuildClientMintStatusStr"] = (wasmExports["Ib"].value) >>> 0;
  _kVersionStampBuildCompilerStr = Module["_kVersionStampBuildCompilerStr"] = (wasmExports["Jb"].value) >>> 0;
  _kVersionStampBuildDateTimePstStr = Module["_kVersionStampBuildDateTimePstStr"] = (wasmExports["Kb"].value) >>> 0;
  _kVersionStampBuildDepotPathStr = Module["_kVersionStampBuildDepotPathStr"] = (wasmExports["Lb"].value) >>> 0;
  _kVersionStampBuildIdStr = Module["_kVersionStampBuildIdStr"] = (wasmExports["Mb"].value) >>> 0;
  _kVersionStampBuildInfoStr = Module["_kVersionStampBuildInfoStr"] = (wasmExports["Nb"].value) >>> 0;
  _kVersionStampBuildLabelStr = Module["_kVersionStampBuildLabelStr"] = (wasmExports["Ob"].value) >>> 0;
  _kVersionStampBuildTargetStr = Module["_kVersionStampBuildTargetStr"] = (wasmExports["Pb"].value) >>> 0;
  _kVersionStampBuildTimestampStr = Module["_kVersionStampBuildTimestampStr"] = (wasmExports["Qb"].value) >>> 0;
  _kVersionStampBuildToolStr = Module["_kVersionStampBuildToolStr"] = (wasmExports["Rb"].value) >>> 0;
  _kVersionStampG3BuildTargetStr = Module["_kVersionStampG3BuildTargetStr"] = (wasmExports["Sb"].value) >>> 0;
  _kVersionStampVerifiableStr = Module["_kVersionStampVerifiableStr"] = (wasmExports["Tb"].value) >>> 0;
  _kVersionStampBuildFdoTypeStr = Module["_kVersionStampBuildFdoTypeStr"] = (wasmExports["Ub"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistStr = Module["_kVersionStampBuildBaselineChangelistStr"] = (wasmExports["Vb"].value) >>> 0;
  _kVersionStampBuildLtoTypeStr = Module["_kVersionStampBuildLtoTypeStr"] = (wasmExports["Wb"].value) >>> 0;
  _kVersionStampBuildPropellerTypeStr = Module["_kVersionStampBuildPropellerTypeStr"] = (wasmExports["Xb"].value) >>> 0;
  _kVersionStampBuildPghoTypeStr = Module["_kVersionStampBuildPghoTypeStr"] = (wasmExports["Yb"].value) >>> 0;
  _kVersionStampBuildFdoProfileChangelistStr = Module["_kVersionStampBuildFdoProfileChangelistStr"] = (wasmExports["Zb"].value) >>> 0;
  _kVersionStampBuildMemprofProfileChangelistStr = Module["_kVersionStampBuildMemprofProfileChangelistStr"] = (wasmExports["_b"].value) >>> 0;
  _kVersionStampBuildUsernameStr = Module["_kVersionStampBuildUsernameStr"] = (wasmExports["$b"].value) >>> 0;
  _kVersionStampBuildHostnameStr = Module["_kVersionStampBuildHostnameStr"] = (wasmExports["ac"].value) >>> 0;
  _kVersionStampBuildDirectoryStr = Module["_kVersionStampBuildDirectoryStr"] = (wasmExports["bc"].value) >>> 0;
  _kVersionStampBuildChangelistInt = Module["_kVersionStampBuildChangelistInt"] = (wasmExports["cc"].value) >>> 0;
  _kVersionStampCitcSnapshotInt = Module["_kVersionStampCitcSnapshotInt"] = (wasmExports["dc"].value) >>> 0;
  _kVersionStampBuildClientMintStatusInt = Module["_kVersionStampBuildClientMintStatusInt"] = (wasmExports["ec"].value) >>> 0;
  _kVersionStampBuildTimestampInt = Module["_kVersionStampBuildTimestampInt"] = (wasmExports["fc"].value) >>> 0;
  _kVersionStampVerifiableInt = Module["_kVersionStampVerifiableInt"] = (wasmExports["gc"].value) >>> 0;
  _kVersionStampBuildCoverageEnabledInt = Module["_kVersionStampBuildCoverageEnabledInt"] = (wasmExports["hc"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistInt = Module["_kVersionStampBuildBaselineChangelistInt"] = (wasmExports["ic"].value) >>> 0;
  _kVersionStampPrecookedTimestampStr = Module["_kVersionStampPrecookedTimestampStr"] = (wasmExports["jc"].value) >>> 0;
  _kVersionStampPrecookedClientInfoStr = Module["_kVersionStampPrecookedClientInfoStr"] = (wasmExports["kc"].value) >>> 0;
  __indirect_function_table = wasmExports["__indirect_function_table"];
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = (wasmExports["Sc"].value) >>> 0;
}

var wasmImports = {
  /** @export */ Ab: DefaultErrorReporter,
  /** @export */ zb: GetAdapterArchitecture,
  /** @export */ yb: GetAdapterDescription,
  /** @export */ xb: GetAdapterDeviceName,
  /** @export */ wb: GetAdapterVendor,
  /** @export */ vb: JsGetDeviceMaxSubgroupSize,
  /** @export */ ub: JsGetDeviceMinSubgroupSize,
  /** @export */ tb: ThrowError,
  /** @export */ sb: __Unwind_RaiseException,
  /** @export */ N: __asyncjs__ReadBufferDataJs,
  /** @export */ rb: ___syscall_dup,
  /** @export */ qb: ___syscall_faccessat,
  /** @export */ t: ___syscall_fcntl64,
  /** @export */ pb: ___syscall_fstat64,
  /** @export */ ob: ___syscall_ftruncate64,
  /** @export */ nb: ___syscall_getcwd,
  /** @export */ mb: ___syscall_getdents64,
  /** @export */ lb: ___syscall_ioctl,
  /** @export */ kb: ___syscall_lstat64,
  /** @export */ jb: ___syscall_mkdirat,
  /** @export */ ib: ___syscall_newfstatat,
  /** @export */ M: ___syscall_openat,
  /** @export */ hb: ___syscall_readlinkat,
  /** @export */ gb: ___syscall_rmdir,
  /** @export */ fb: ___syscall_stat64,
  /** @export */ ca: ___syscall_unlinkat,
  /** @export */ eb: ___syscall_utimensat,
  /** @export */ Ya: __abort_js,
  /** @export */ A: __embind_finalize_value_object,
  /** @export */ aa: __embind_register_bigint,
  /** @export */ Xa: __embind_register_bool,
  ...
  /** @export */ Wa: __embind_register_emval,
  /** @export */ $: __embind_register_enum,
  /** @export */ r: __embind_register_enum_value,
  /** @export */ _: __embind_register_float,
  /** @export */ Z: __embind_register_function,
  ...
  /** @export */ X: _emscripten_has_asyncify,
  /** @export */ Ja: _emscripten_outn,
  /** @export */ Ia: _emscripten_pc_get_function,
  /** @export */ Ha: _emscripten_resize_heap,
  /** @export */ W: _emscripten_sleep,
  /** @export */ V: _emscripten_stack_snapshot,
  /** @export */ Ga: _emscripten_stack_unwind_buffer,
  /** @export */ U: _emscripten_webgpu_get_device,
  /** @export */ Fa: _emwgpuBufferDestroy,
  /** @export */ Ea: _emwgpuBufferGetConstMappedRange,
  /** @export */ Da: _emwgpuBufferGetMappedRange,
  /** @export */ Ca: _emwgpuBufferMapAsync,
  ...
  /** @export */ ya: _emwgpuDeviceCreateComputePipelineAsync,
  /** @export */ xa: _emwgpuDeviceCreateShaderModule,
  /** @export */ wa: _emwgpuDeviceDestroy,
  /** @export */ va: _emwgpuQueueOnSubmittedWorkDone,
  /** @export */ ua: _emwgpuWaitAny,
  /** @export */ cb: _environ_get,
  /** @export */ bb: _environ_sizes_get,
  /** @export */ T: _exit,
  /** @export */ B: _fd_close,
  /** @export */ ab: _fd_pread,
  /** @export */ ba: _fd_read,
  /** @export */ $a: _fd_seek,
  /** @export */ H: _fd_write,
  /** @export */ _a: _proc_exit,
  /** @export */ Za: _random_get,
  /** @export */ S: _wgpuBufferGetSize,
  /** @export */ ta: _wgpuBufferGetUsage,
  ...
  /** @export */ sa: _wgpuCommandEncoderCopyBufferToTexture,
  /** @export */ ra: _wgpuCommandEncoderCopyTextureToBuffer,
  /** @export */ qa: _wgpuCommandEncoderCopyTextureToTexture,
  /** @export */ i: _wgpuCommandEncoderFinish,
  /** @export */ pa: _wgpuCommandEncoderResolveQuerySet,
  /** @export */ q: _wgpuComputePassEncoderDispatchWorkgroups,
  /** @export */ o: _wgpuComputePassEncoderEnd,
  /** @export */ oa: _wgpuComputePassEncoderSetBindGroup,
  /** @export */ R: _wgpuComputePassEncoderSetPipeline,
  /** @export */ na: _wgpuDeviceCreateBindGroup,
  /** @export */ ma: _wgpuDeviceCreateBindGroupLayout,
  /** @export */ h: _wgpuDeviceCreateCommandEncoder,
  /** @export */ la: _wgpuDeviceCreateComputePipeline,
  /** @export */ ka: _wgpuDeviceCreatePipelineLayout,
  /** @export */ ja: _wgpuDeviceCreateQuerySet,
  /** @export */ ia: _wgpuDeviceCreateTexture,
  /** @export */ D: _wgpuDeviceGetAdapterInfo,
  /** @export */ ha: _wgpuDeviceGetLimits,
  /** @export */ ga: _wgpuDeviceHasFeature,
  /** @export */ d: _wgpuQueueSubmit,
  /** @export */ Q: _wgpuQueueWriteBuffer,
  /** @export */ fa: _wgpuQueueWriteTexture,
  /** @export */ ea: _wgpuTextureCreateView,
  /** @export */ da: _wgpuTextureDestroy,
  /** @export */ P: _wgpuTextureGetDepthOrArrayLayers,
  /** @export */ C: _wgpuTextureGetHeight,
  /** @export */ O: _wgpuTextureGetWidth
};
...
function applySignatureConversions(wasmExports) {
  ...
  wasmExports["Tc"] = makeWrapper_pp(wasmExports["Tc"]);
  wasmExports["Uc"] = makeWrapper_ppp(wasmExports["Uc"]);
  wasmExports["Vc"] = makeWrapper_ppp(wasmExports["Vc"]);
  wasmExports["Xc"] = makeWrapper_pp(wasmExports["Xc"]);
  wasmExports["Yc"] = makeWrapper_p(wasmExports["Yc"]);
  return wasmExports;
}
